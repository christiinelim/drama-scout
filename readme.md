...
![Place Search](image/readme/place-search.png)

*Direction: Search for a recommended route between 2 locations.*
![Directions](image/readme/direction.png)

*Place Detail: Retrieve details of place of interest and view the current weather condition.*
![Place Detail](image/readme/place-detail.png)
![Place Detail](image/readme/weather.png)
